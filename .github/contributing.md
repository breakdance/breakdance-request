# Contributing to breakdance-request

First and foremost, thank you! We appreciate that you want to contribute to breakdance-request, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for breakdance-request**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for breakdance-request:

- star the [project](https://github.com/jonschlinkert/breakdance-request)
- tweet your support for breakdance-request
...
- **version**: please note the version of breakdance-request are you using
...
[so]: http://stackoverflow.com/questions/tagged/breakdance-request